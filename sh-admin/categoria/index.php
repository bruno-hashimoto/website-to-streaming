<?php
	...
	0,// TIPO DA PAGINA?O. 1 limpa ,0 suja

	$rPagina,//TOTAL DE REGISTROS POR PAGINA

	'?a='.$enderecoPasta.'&q='.$_GET['q'] //VARIAVEIS PASSADAS NA PAGINA?O
...
<div id="meio">
    ...
    <div id="listagem">
        ...
        <a href="?a=<?php echo $cadastra;?>" class="adicionar" title="Cadastrar um novo registro">Adicionar</a> <!--BOT? CADASTRAR -->
    ...
    <div class="listas">
        ...
        <table width="100%" border="0" cellspacing="2" cellpadding="0" class="sortTable" id="<?php echo $tabela;?>" fOrdem="<?php echo $fOrdem;?>">
        	...
        	<thead>
            	<tr>
                    ...
                    <th width="5%" align="left">Destaque</th>
            ...
            ?>
                <tr id="<?php echo $ln['id'];?>"  <?php echo $title;?> class="<?php echo $clInfo;?> cadPor <?php echo $pAlt!==1?' nodrag nodrop ':'';?>">
                    ...
                    <td align="left"><?php echo $ln['destaque'] == 1 ? 'Sim':'Não';?></td>
    		...
    		<?php
    		 ...
    		 ?>
                <tr class="inf-busca-reg">
                    <td  align="center">
                        <?php echo !empty($_GET['q']) ? 'Sua busca n? trouxe nenhum resultado !':'N? h?registros cadastrados !';?>
                    </td>
                </tr>
    		<?php
    			}
        ...
        <?php
			echo $page->navegacao(); //CONTROLES DA PAGINA?O < 1 2 3 >
        ?>
</div>