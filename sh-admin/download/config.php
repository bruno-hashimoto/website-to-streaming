<?php
    ...
    */
    ...
    //BUSCA
    $busca = 't.titulo,t.texto,t.arquivo';//CAMPOS A SEREM FILTRADOS NA BUSCA,SEPARADOS POR , . EX: t.nome , t.titulo , c.categoria , f.comentario
    //FIM BUSCA
    ...
    (
        ...
        'Disponível até'=>array('campo'=>'disponivel_ate','tipo'=>'data_d'),
        'Descrição'=>array('campo'=>'texto','tipo'=>'texto'),
