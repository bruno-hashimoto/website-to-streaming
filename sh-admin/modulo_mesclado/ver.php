...
<div id="meio">
  <div id="listagem">
    ...
    <a href="<?php echo $_SESSION['continue'];?>" class="voltar-modulo" >&lsaquo;&mdash;&nbsp;Voltar para <?php echo $titulo;?></a>
					...
					switch($arr['tipo'])
					{
						...
						case 'valor':
							...
							'
								<div>
									<label>'.$titulo.'</label>
									<div class="ver">'.fvalor($campo).'</div>
								</div>
							';
						break;
						case 'banner':
						...
						case'download':
							...
							'
								<div class="download-ver">
									<label>'.$titulo.'</label>
									<a href="'._FILES_.$campo.'" target="_blank">
										Baixar arquivo
									<a>
								</div>
							';
