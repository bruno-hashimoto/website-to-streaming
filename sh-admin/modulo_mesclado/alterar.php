	...
	if($_SERVER['REQUEST_METHOD']=='POST')
	{
		...
		if($alteracao===true)
		{
			logs(3,$tabela,$_POST['id'],$_SESSION['id_user']);
      		location(urlencode($_SESSION['continue']),'Alteração efetuada !',1);//REDIRECIONAMENTO
		}
		else
		{
			logs(4,$tabela,$_POST['id'],$_SESSION['id_user']);
      		location(urlencode($_SESSION['continue']),'Erro, ao tentar alterar !');//REDIRECIONAMENTO
		}
	}
