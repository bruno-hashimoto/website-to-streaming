<?php
	...
	*/
	...
	//MODULO MESCLADO
	$moduloReferenciaNome   = $_GET['moduloReferenciaNome'];
	$moduloReferenciaTitulo = $_GET['moduloReferenciaTitulo'];
	$moduloReferenciaID     = $_GET['moduloReferenciaID'];
	$moduloReferenciaLink   = urlencode($_GET['moduloReferenciaLink']);
	$moduloReferenciaPasta  = $_GET['moduloReferenciaPasta'];

	$moduloReferenciaUrl    = '&moduloReferenciaTitulo='.$moduloReferenciaTitulo.'&moduloReferenciaID='.$moduloReferenciaID.'&moduloReferenciaLink='.$moduloReferenciaLink.'&moduloReferenciaPasta='.$moduloReferenciaPasta.'&moduloReferenciaNome='.$moduloReferenciaNome;
	//FIM MODULO MESCLADO

	$titulo 		= 'Modulo do , '.$moduloReferenciaTitulo;

	$tabela 		= 'modulo'; //SEM PREFIXO

	$pasta 			= urllimpa($tabela);

	$tabela 		= 'sh_'.$tabela; //PREFIXO + TABELA

	$enderecoPasta 	= $pasta.'/index'.$moduloReferenciaUrl;

	$cadastra   	= $pasta.'/cadastra'.$moduloReferenciaUrl;

	$alterar		= $pasta.'/alterar'.$moduloReferenciaUrl;

	$ver			= $pasta.'/ver'.$moduloReferenciaUrl;

	//$fotos			= $pasta.'/fotos'.$moduloReferenciaUrl; //LIBERA O GERENCIAMENTO DE FOTOS PARA ESSE MODULO

	//$mesclado         = 'modulo_mesclado/index';

	//BUSCA
	$busca = 't.titulo,t.chamada,t.texto';//CAMPOS A SEREM FILTRADOS NA BUSCA,SEPARADOS POR , . EX: t.nome , t.titulo , c.categoria , f.comentario
	//FIM BUSCA
