<?php
	...
	("
		...
		WHERE
			...
			$wVisible
			$wBusca
			and t.id_modulo_referencia = ".$moduloReferenciaID."
...
<div id="meio">
    ...
    <div id="listagem">
        ...
        <ul class="bread"> <!-- ONDE ESTOU -->
            ...
            <li><a href="<?php echo $_SERVER['REQUEST_URI'];?>"><?php echo $titulo;?></a></li>
        </ul>
        ...
        <ul class="busca"> <!--BUSCA-->
        	<form action="" method="get" id="busca-modulo">
            	<input type="hidden" name="a" value="<?php echo $pasta,'/index';?>"  /> <!--ENDERECO DO MODULO ATUAL-->

                <input type="hidden" name="moduloReferenciaNome" value="<?php echo $moduloReferenciaNome;?>" />
                <input type="hidden" name="moduloReferenciaTitulo" value="<?php echo $moduloReferenciaTitulo;?>" />
                <input type="hidden" name="moduloReferenciaID" value="<?php echo $moduloReferenciaID;?>" />
                <input type="hidden" name="moduloReferenciaLink" value="<?php echo urldecode($moduloReferenciaLink);?>" />
                <input type="hidden" name="moduloReferenciaPasta" value="<?php echo $moduloReferenciaPasta;?>" />
        ...
        <table width="100%" border="0" cellspacing="2" cellpadding="0" class="sortTable" id="<?php echo $tabela;?>" fOrdem="<?php echo $fOrdem;?>">
        	...
        	<thead>
            	<tr>
                    ...
                    <th width="65%" align="left">Titulo</th>
                    ...
                    <?php
    					...
    					{
                    ?>
                    	<th width="5%" align="center" class="no_sort">Referencia</th>
                    <?php
    					}
                    ?>
                    <?php
            ...
            ?>
                <tr id="<?php echo $ln['id'];?>"  <?php echo $title;?> class="<?php echo $clInfo;?> cadPor <?php echo $pAlt!==1?' nodrag nodrop ':'';?>">
                    ...
                    <td align="left"><?php echo $ln['titulo'];?></td>
                    ...
                    ?>
                    <td  align="center">
                        <a href="?a=<?php echo $mesclado.'&moduloReferenciaTitulo='.urlencode($ln['titulo']).'&moduloReferenciaID='.$ln['id'].'&moduloReferenciaLink='.urlencode($_SESSION['continue']).'&moduloReferenciaPasta='.$moduloReferenciaPasta.'&moduloReferenciaNome='.$titulo;?>" title="">
                            <img src="imgs_site/ref.png" width="15" height="15" />
                        </a>
                    </td>
                    <?php
    					}
