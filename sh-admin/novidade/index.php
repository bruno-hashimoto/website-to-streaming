<?php
	...
	("
		...
		FROM
            ...
            join sh_categoria c on( t.id_categoria = c.id )
        ...
        <table width="100%" border="0" cellspacing="2" cellpadding="0" class="sortTable" id="<?php echo $tabela;?>" fOrdem="<?php echo $fOrdem;?>">
        	...
        	<thead>
            	<tr>
                    ...
                    <th width="55%" align="left">Titulo</th>
                    <th width="10%" align="left">Categoria</th>

                    <!--FIM COLUNAS-->

                    <th width="5%" align="center" class="no_sort">Destaque</th>
            ...
            ?>
                <tr id="<?php echo $ln['id'];?>"  <?php echo $title;?> class="<?php echo $clInfo;?> cadPor <?php echo $pAlt!==1?' nodrag nodrop ':'';?>">
                    ...
                    <!--COLUNAS-->
                    <td align="center"><?php echo lightbox($ln['img'],'89x60','alt="Foto" title="'.$ln['titulo'].'" ',true);?></td>

                    <td align="left"><?php echo $ln['titulo'];?></td>
                    <td align="left"><?php echo traco( $ln['categoria']);?></td>

                    <!--FIM COLUNAS-->

                    <td  align="center" >
                        <?php echo ($ln['destaque']==1) ? 'Sim':'Não';?>
                    </td>
                    ...
                    ?>
                    <td  align="center">
                        <a href="?a=<?php echo $mesclado.'&moduloReferenciaTitulo='.urlencode($ln['titulo']).'&moduloReferenciaID='.$ln['id'].'&moduloReferenciaLink='.urlencode($_SESSION['continue']).'&moduloReferenciaPasta='.$pasta.'&moduloReferenciaNome='.$titulo;?>" title="">
