...
function CheckAuthentication()
{
	...
	return (isset($_SESSION['id_user'])!==true || is_numeric($_SESSION['id_user']) !==true || $_SESSION['session_id'] !== session_id() || $_SESSION['status_user']!==1 || $_SESSION['excluido_user']!==0 ) ? false:true;
	//return true;
}
...
*/
$baseUrl = _BASE_.'sh-admin/editor/ckfinder/userfiles/';
