<?php
    ...
    */
    ...
    //BUSCA
    $busca = 't.nome,t.email,t.mensagem,t.assunto';//CAMPOS A SEREM FILTRADOS NA BUSCA,SEPARADOS POR , . EX: t.nome , t.titulo , c.categoria , f.comentario
    //FIM BUSCA
    ...
    $visualizacao = array
    (
        //'Foto'=>array('campo'=>'img','tipo'=>'image'),
        'Nome'=>array('campo'=>'nome','tipo'=>'texto'),
        'E-mail'=>array('campo'=>'email','tipo'=>'texto'),
        'Telefone'=>array('campo'=>'celular','tipo'=>'texto'),
        //'Chamada'=>array('campo'=>'chamada','tipo'=>'texto'),
        'Mensagem'=>array('campo'=>'mensagem','tipo'=>'texto'),
        //'Data'=>array('campo'=>'data','tipo'=>'datahora'),
        ...
        'Arquivo'=>array('campo'=>'arquivo','tipo'=>'download')
    );
    //FIM VISUALIZAR
