<?php
	...
	*/
	...
	//BUSCA
	$busca = 't.nome,t.pasta';//CAMPOS A SEREM FILTRADOS NA BUSCA,SEPARADOS POR , . EX: t.nome , t.titulo , c.categoria , f.comentario
	//FIM BUSCA
	...
	(
		...
		'pasta'=>array('campo'=>'pasta','tipo'=>'texto'),
