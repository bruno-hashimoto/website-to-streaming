  ...
  <div id="listagem">
    ...
    <div id="inserir">
      <form action="" method="post" class="validaFormulario" enctype="multipart/form-data" id="formAlterar">
        ...
        <div>
            <label>Pasta</label>
            <input name="input[pasta]" type="text" value="<?php echo $ln['pasta'];?>"/>
        </div>
        <div>
            <label>Url inicial</label>
            <input name="input[url]" type="text" value="<?php echo $ln['url'];?>" />
        </div>
        <!--
        <div>
        	<label>Chamada</label>
       ...
       <!--
        ...
        <div>
            ...
            <select name="input[tipo]">
              <option value="">Selecione uma opção</option>
              <option value="0" <?php echo $ln['tipo']==0 ? 'selected="selected"':'';?> >Site</option>
              <option value="1" <?php echo $ln['tipo']==1 ? 'selected="selected"':'';?> >E-Commerce</option>
              <option value="2" <?php echo $ln['tipo']==2 ? 'selected="selected"':'';?> >Sistema</option>
            </select>
        </div>
        <div>
            <label>Status</label>
