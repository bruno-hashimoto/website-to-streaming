...
<div id="meio">
    ...
    <div id="listagem">
        ...
        <a href="js/upload/index.php?id_modulo=<?php echo $_GET['id'];?>&modulo=<?php echo $tabela.'&title='.urlencode($msgfotos);?>" class="adicionar upload adicionar-fotos">Adicionar</a> <!--BOTÃO CADASTRAR -->
        <a href="<?php echo $_SESSION['continue'];?>" title="Voltar para <?php echo $titulo;?>" alt="Voltar para <?php echo $titulo;?>" class="voltar-modulo" >&lsaquo;&mdash;&nbsp;Voltar para <?php echo $titulo;?></a>
            ...
            <table width="100%" border="0" cellspacing="2" cellpadding="0" class="sortTable" id="sh_file" fOrdem="<?php echo $fOrdem;?>" id_modulo="<?php echo $_GET['id']?>" modulo="<?php echo $tabela;?>" >
                <thead>
                    <tr>
                        ...
                        <th width="70%" align="left">Comentário</th>
...
<?php
    $isPhotos = $sql->rows( $sql->query( 'SELECT * FROM `sh_file` WHERE excluido = 0 and id_modulo='.$_GET['id'].' and modulo="'.$tabela.'"' ) ) > 0;
