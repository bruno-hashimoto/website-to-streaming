<?php
	...
	*/
	...
	//BUSCA
	$busca = 't.titulo,t.link,t.chamada';//CAMPOS A SEREM FILTRADOS NA BUSCA,SEPARADOS POR , . EX: t.nome , t.titulo , c.categoria , f.comentario
	//FIM BUSCA
	...
	(
		...
		'Link'=>array('campo'=>'link','tipo'=>'texto'),
